      ...
      <section className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-center gap-10 px-6 py-16 md:px-16 lg:px-24 bg-blue-100 dark:bg-slate-900">
        <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-xl mx-auto md:mx-0 leading-relaxed">
            ...
            React.js and Node.js. Passionate about creating scalable backend
            APIs and responsive user experiences.
          </p>
          ...
          <div className="flex gap-4 pt-6 justify-center md:justify-start">
            {[
              ...
              {
                src: linkedin,
                link: "https://www.linkedin.com/in/prachishree111/",
              },
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-white dark:bg-slate-700 p-3.5 rounded-2xl shadow-md hover:scale-110 hover:shadow-blue-200 dark:hover:shadow-blue-900 transition-all"
              >
                <img
                  src={item.src}
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xl text-gray-800 dark:text-gray-300 leading-relaxed font-medium">
              ...
              React.js, Node.js, JavaScript, REST APIs, JWT Authentication and
              Git. I enjoy solving real-world problems through clean and
              scalable code.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12">
              <div className="flex items-center gap-5 p-6 bg-white dark:bg-slate-700 rounded-2xl shadow-sm border border-blue-100 dark:border-slate-600">
                ...
                <div>
                  <p className="text-xs uppercase text-gray-500 font-black tracking-widest">
                    Experience
                  </p>
      ...
      <section className="bg-blue-100 dark:bg-slate-900 px-6 py-24">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16">
          <div className="flex-1 space-y-10">
            ...
            <div className="space-y-6">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-5 text-lg text-gray-800 dark:text-gray-200 group"
                >
                  <div className="bg-white dark:bg-slate-700 p-4 rounded-2xl shadow-sm group-hover:bg-blue-600 transition-colors">
                    <img
                      src={item.img}
                      className="h-6 w-6 dark:invert group-hover:invert-0"
                      alt="icon"
                    />
                  </div>
                  <p className="font-semibold hover:text-blue-500 transition-colors cursor-pointer">
                    {item.val}
                  </p>
                </div>
              ))}
          ...
          <form
            ref={form}
            onSubmit={sendEmail}
            className="flex-1 bg-white dark:bg-slate-800 p-10 rounded-[2.5rem] shadow-2xl space-y-5 border border-blue-50 dark:border-slate-700"
          >
            <input
              name="user_name"
              placeholder="Your Name"
              className="w-full p-4.5 py-2 px-2 rounded-xl border border-gray-200 dark:border-slate-600 bg-gray-50 dark:bg-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all font-medium"
              required
            />
            <input
              name="user_email"
            ...
            <textarea
              ...
              rows="5"
              className="w-full p-4.5 py-2 px-2 rounded-xl border border-gray-200 dark:border-slate-600 bg-gray-50 dark:bg-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none font-medium"
              required
            />
